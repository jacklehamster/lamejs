...
class Quantize {
    ...
    constructor() {
         ...
         */
        function psfb21_analogsilence(gfc, cod_info, qupvt) {
            var ath = gfc.ATH;
            var xr = cod_info.xr;
        ...
        this.init_outer_loop = function (gfc, cod_info) {
            ...
            psfb21_analogsilence(gfc, cod_info, this.qupvt);
        };
         ...
         * to start with
         */
        function bin_search_StepSize(gfc, cod_info, desired_rate, ch, xrpow, tk) {
            var nBits;
         ...
         */
        function inc_subblock_gain(gfc, cod_info, xrpow, qupvt) {
            var sfb;
         ...
         * </PRE>
         */
        function balance_noise(gfp, cod_info, distort, xrpow, bRefine, tk, qupvt) {
            var gfc = gfp.internal_flags;
            ...
            if (gfc.noise_shaping > 1) {
                ...
                if (0 == cod_info.scalefac_scale) {
                    ...
                    if (cod_info.block_type == Encoder.SHORT_TYPE
                        && gfc.subblock_gain > 0) {
                        status = (inc_subblock_gain(gfc, cod_info, xrpow, qupvt) || loop_break(cod_info));
                    }
                }
            }
        ...
        this.outer_loop = function (gfp, cod_info, l3_xmin, xrpow, ch, targ_bits) {
            ...
            bin_search_StepSize(gfc, cod_info, targ_bits, ch, xrpow, this.tk);
            ...
            this.qupvt.calc_noise(cod_info, l3_xmin, distort, best_noise_info,
                prev_noise);
            ...
            while (!bEndOfSearch) {
                ...
                do {
                    ...
                    if (!balance_noise(gfp, cod_info_w, distort, xrpow, bRefine, this.tk, this.qupvt))
                        break;
                     ...
                     * maximum
                     */
                    while ((cod_info_w.part2_3_length = this.tk.count_bits(gfc, xrpow,
                    ...
                    if (best_noise_info.over_count == 0) {
                        ...
                        while ((cod_info_w.part2_3_length = this.tk.count_bits(gfc,
                    ...
                    /* compute the distortion in this quantization */
                    this.qupvt.calc_noise(cod_info_w, l3_xmin, distort, noise_info,
                        prev_noise);
        ...
        this.get_framebits = function (gfp, frameBits) {
            ...
            var bitsPerFrame = this.bs.getframebits(gfp);
        ...
        this.VBR_old_prepare = function (gfp, pe, ms_ener_ratio, ratio, l3_xmin, frameBits, min_bits,
            ...
            var avg = this.rv.ResvFrameBegin(gfp, new MeanBits(0)) / gfc.mode_gr;
    
            get_framebits(gfp, frameBits);
    
            for (var gr = 0; gr < gfc.mode_gr; gr++) {
                var mxb = this.qupvt.on_pe(gfp, pe, max_bits[gr], avg, gr, 0);
                ...
                for (var ch = 0; ch < gfc.channels_out; ++ch) {
                    ...
                    bands[gr][ch] = this.qupvt.calc_xmin(gfp, ratio[gr][ch], cod_info,
                        l3_xmin[gr][ch]);
                    if (bands[gr][ch] != 0)
                        analog_silence = 0;
        ...
        this.VBR_new_prepare = function (gfp, pe, ratio, l3_xmin, frameBits, max_bits) {
            ...
            for (var gr = 0; gr < gfc.mode_gr; gr++) {
                ...
                for (var ch = 0; ch < gfc.channels_out; ++ch) {
                    ...
                    init_outer_loop(gfc, cod_info);
                    if (0 != this.qupvt.calc_xmin(gfp, ratio[gr][ch], cod_info,
                            l3_xmin[gr][ch]))
                        analog_silence = 0;
        ...
        this.calc_target_bits = function (gfp, pe, ms_ener_ratio, targ_bits, analog_silence_bits, max_frame_bits) {
            ...
            if (gfc.mode_ext == Encoder.MPG_MD_MS_LR)
                for (gr = 0; gr < gfc.mode_gr; gr++) {
                    this.qupvt.reduce_side(targ_bits[gr], ms_ener_ratio[gr], mean_bits
                        * gfc.channels_out,
