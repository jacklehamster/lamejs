...
class Takehiro {
    ...
    constructor() {
         ...
         */
        function quantize_lines_xrpow(l, istep, xr, xrPos, ix, ixPos, qupvt) {
            assert(l > 0);
         ...
         */
        function quantize_xrpow(xp, pi, istep, codInfo, prevNoise, qupvt) {
                ...
                if (prev_data_use && (prevNoise.step[sfb] == step)) {
                    ...
                    if (accumulate != 0) {
                        quantize_lines_xrpow(accumulate, istep, acc_xp, acc_xpPos,
                            acc_iData, acc_iDataPos, qupvt);
                        accumulate = 0;
                    }
                    if (accumulate01 != 0) {
                        quantize_lines_xrpow_01(accumulate01, istep, acc_xp,
                            acc_xpPos, acc_iData, acc_iDataPos, qupvt);
                        accumulate01 = 0;
                    }
        ...
        this.count_bits = function (gfc, xr, gi, prev_noise) {
            ...
            quantize_xrpow(xr, ix, this.qupvt.IPOW20(gi.global_gain), gi, prev_noise, this.qupvt);
